...
from app import db
from app.models import Client, Membership, Payment, Routine, Progress
from app.forms import ClientForm, MembershipForm, PaymentForm, RoutineForm, ProgressForm
from app.utils.membership import effective_membership_price
    ...
    if request.method == 'POST':
        if not form.validate_on_submit():
            ...
            try:
                ...
                qr_filepath = os.path.join(os.getcwd(), 'app', 'static', 'images', qr_filename)
